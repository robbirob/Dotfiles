...
hl.config({
    general = {
        ...
        -- Match the Waybar palette.
        col = {
            active_border   = { colors = {"rgba(313244ff)", "rgba(45475aff)"}, angle = 45 },
...
hl.animation({ leaf = "global",        enabled = true,  speed = 14,   bezier = "default" })
...
hl.animation({ leaf = "windowsIn",     enabled = true,  speed = 6.5,  spring = "easy",         style = "popin 87%" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true,  speed = 3.2,  bezier = "almostLinear" })
...
-- Capture the intended reload shortcut so Ctrl+R is not passed through to terminals.
